package com.roka.geopathtrace.view.widget;
...
public class SwipeButton extends RelativeLayout {
    ...
    private SwipeOnStateChangeListener stateListener;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        background.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_rounded_swipe_button));
        ...
        centerText.setText("Swipe to start"); //add any text you need
        ...
        disabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_start_tracking_black_24dp);
        enabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_stop_tracking_black_24dp);
    ...
    public void setStateListener(SwipeOnStateChangeListener stateListener) {
